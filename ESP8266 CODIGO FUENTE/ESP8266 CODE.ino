...
void loop() {
  ...
  //---------enviamos las variables al servidor---------------------
      ...
      {  
          ...
          peticionHTTP=peticionHTTP+String(variable1)+"&t2="+String(variable2)+"&t3="+String(variable2)+"&h1="+String(variable2)+"&h2="+String(variable2)+"&h3="+String(variable2)+"&hr1="+String(variable2)+"&hr2="+String(variable2)+" HTTP/1.1\r\n";
  ...
  delay(3.6e+6); //pausa de 10seg antes de conectarse nuevamente al servidor (opcional)
    resetFunc();
}
